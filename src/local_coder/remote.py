...
class RemoteControlServer:
    ...
    def __init__(self, project_root: str, config_path: str | None = None, model_name: str | None = None):
    ...
    def handle(self, method: str, path: str, body: dict[str, Any] | None = None) -> tuple[int, dict[str, Any]]:
        ...
        if method == "POST" and path in {"/plan", "/run", "/review"}:
            ...
            session_id = body.get("session_id") or f"session-{len(self.sessions.list()) + 1}"
